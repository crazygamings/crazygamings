...
if gg.getResultCount() == 0 then
gg.alert("اغلق اللعبة والجيم جاردن وعيد المحاولة مرة أخرى")
else
...
gg.clearResults()
gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber("FFFFFFFFE3010D44h;FFFFFFFFEE300A41h;-FFFFFFFFE7940000h:9", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.refineNumber("FFFFFFFFEE300A41h", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.refineAddress("98")
  ...
  gg.clearResults()
gg.setRanges(gg.REGION_CODE_APP)
  gg.searchNumber("-11993948", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.refineNumber("-11993948", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.refineAddress("A23")
  for i, i in ipairs((gg.getResults(100, nil, nil, nil, nil, nil, nil, nil, nil))) do
    if i.flags == gg.TYPE_DWORD then
      i.value = "5"
      i.freeze = true
...
function AqAq()
  SN4 = gg.choice({
    ...
    "《🔴 [2] حماية اللوبي لجميع النسخ وتفعيلها في اللوبي - ترسيت كل زون",
    "《↩ رجوع للخلف ",
