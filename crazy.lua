...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
local tb1 = {{134914, 0}, {16384, 0}, {196864, -252}, {16384, 4}, {16384, 8},{16384, 12},{16384, 16},{16384, 20},{16384, 508}, } 
local tb2 = {{0, 0},{0, 0}, } 
local dt = 16
...
function NewValue()
  ...
  gg.editAll("0", gg.TYPE_DWORD)
  gg.clearResults()
gg.alert("تم تفعيل الحمايه التجريبية")
end
