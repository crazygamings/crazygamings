...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("131104", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(50000)
local dk = gg.getResults(50000)
for i, v in ipairs(dk) do
    dk[i].flags = gg.TYPE_DWORD
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("131586;134658", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(50000)
local dk = gg.getResults(50000)
for i, v in ipairs(dk) do
    dk[i].flags = gg.TYPE_DWORD
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("134146", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(50000)
local dk = gg.getResults(50000)
for i, v in ipairs(dk) do
    dk[i].flags = gg.TYPE_DWORD
