...
function setvalue(A0_2, A1_3, A2_4)
  local L3_5
  L3_5 = {}
  L3_5[1] = {}
  L3_5[1].address = A0_2
...
gg.clearResults()
  ...
  function NORECMN1()
    NORECMN1NMN = gg.multiChoice({
      ...
      "🕸 • ثبات سلاح 65% (1) ",
      "🕸 • ثبات سلاح 65% (2) ",
      "⚙️ • منع إهتزاز السلاح ( كاميرا ) ",
      "💢 • تصغير مؤشر التصويب ( صليب جمالي ) ",
      ("⁦➡️⁩• رجوع للخلف")
    }, nil, ("قائمة ثبات الأسلحة قيد التجربة"))
    if NORECMN1NMN == nil then
    else
      if NORECMN1NMN[1] == true then
        NOREC100()
      else
      end
      if NORECMN1NMN[2] == true then
        LESSREC1()
      else
      end
      if NORECMN1NMN[3] == true then
        LESSREC2()
      else
      end
      if NORECMN1NMN[4] == true then
        NOSHAKE()
      else
      end
      if NORECMN1NMN[5] == true then
        SMALLCROSS()
      else
      end
      if NORECMN1NMN[6] == true then
        Main()
      else
      end
    end
  ...
  function NOREC100()
    gg.clearResults()
    setvalue(gg.getRangesList(("libUE4.so"))[1].start + 19031300, 16, 0)
