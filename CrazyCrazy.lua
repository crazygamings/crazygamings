...
function AqAq()
  SN4 = gg.choice({
    "《🟥 [1] حماية النسخه للعالمية فقط", 
    "《🟩 [2] حماية النسخه الكورية والفيتنامية فقط", 
    "《↩ رجوع للخلف ",
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("1010004", 4, false, 536870912, 0, -1)
gg.getResults(50000)
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("1010020", 4, false, 536870912, 0, -1)
gg.getResults(50000)
local Crazy = gg.getResults(50000)
for i, v in ipairs(Crazy) do
    Crazy[i].flags = gg.TYPE_DWORD
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("135168", 4, false, 536870912, 0, -1)
gg.getResults(50000)
local Crazy = gg.getResults(50000)
for i, v in ipairs(Crazy) do
    Crazy[i].flags = gg.TYPE_DWORD
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("133,378", 4, false, 536870912, 0, -1)
gg.getResults(50000)
local Crazy = gg.getResults(50000)
for i, v in ipairs(Crazy) do
    Crazy[i].flags = gg.TYPE_DWORD
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("1,019,270", 4, false, 536870912, 0, -1)
gg.getResults(50000)
local Crazy = gg.getResults(50000)
for i, v in ipairs(Crazy) do
    Crazy[i].flags = gg.TYPE_DWORD
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("135426;135682", gg.TYPE_DWORD)
...
gg.toast("Yellow Body Activated")
    ...
    whs855s2 = gg.getResults(69696969)
    gg.editAll("120", gg.TYPE_FLOAT)
    gg.clearResults()
    end
