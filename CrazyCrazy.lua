...
gg.alert("❌ Failed Restart Game And Try \n لم يتم التفعيل سيتم اغلاق اللعبة !! ❌")
gg.setVisible(true)
gg.processKill()
os.exit()
else
...
gg.addListItems({[1] = {address = results[i].address + 512,flags = 4,freeze = true,value = 4451}})
gg.addListItems({[1] = {address = results[i].address + 540,flags = 4,freeze = true,value = 0}})
...
gg.addListItems({[1] = {address = results[i].address + 68,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 64,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 48,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 64,flags = 4,freeze = true,value = 119}})
gg.addListItems({[1] = {address = results[i].address + 68,flags = 4,freeze = true,value = -1}})
...
gg.addListItems({[1] = {address = results[i].address + 544,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 548,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 30,flags = 4,freeze = true,value = 119}})
...
gg.addListItems({[1] = {address = results[i].address + 200,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 300,flags = 4,freeze = true,value = 4451}})
gg.addListItems({[1] = {address = results[i].address + 310,flags = 4,freeze = true,value = 0}})
...
gg.addListItems({[1] = {address = results[i].address + 68,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 64,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 30,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 130,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 180,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 200,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = results[i].address + 300,flags = 4,freeze = true,value = -1}})
...
gg.getResults(24)
gg.clearResults()
gg.alert(" 🟩 تم التفعيل ... رست الزون الاول ")
end
function Main2()
  Crazy9 = gg.choice({
    "《🩸 • تفعيل/ايقاف سبيد فلاش - خطير"..fspeed1,
    "《🔅 • تفعيل/ايقاف ست سكوب - خطير "..stand2,
    "《💥 • تفعيل/ايقاف ستاند سكوب - خطير"..stand1,
    "《🎯 • هيدشوت 1000",
    "《➿ • تفعيل/ايقاف قفزه للامام "..fspeed11,
...
gg.clearResults()
gg.setValues(fqspeed1s1)
gg.setValues(fqspeed1s2)
gg.setValues(fqspeed1s3)
gg.setValues(fqspeed1s4)
gg.setValues(fqspeed1s5)
gg.clearResults()
...
function AqAq()
  SN4 = gg.choice({
    "《🟥 [1] حماية التفعيلين لجميع النسخ - جرب جيست قيم", 
    "《🟪 [2] حماية جميع النسخ - جرب جيست قيم", 
    "《↩ رجوع للخلف ",
...
function lobby2one()
ss1 = gg.multiChoice({
"🟪 (1) حماية لوبي - تتفعل أول شي  ",
"🟩 (2) حماية التدريب - داخل التدريب فعلها وطخ ٢٠٠ طلقه",
"❌ رجوع إلى الخلف",
...
NotXAnuGame = gg.alert('🟩 تم تفعيل حمايه التدريب بنجاح 🟩')
ontraining1()
end
end
