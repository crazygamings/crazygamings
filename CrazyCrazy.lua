...
function testone1()
  ...
  local t = gg.getResults(30000, nil, nil, nil, nil, nil, nil, nil, nil)
  if gg.getResultCount() == 0 then
  gg.alert("❌ Failed Restart Game And Try , انتبه لم يتم التفعيل سيتم اغلاق اللعبه نظف وفعل مرة اخرى ❌")
  gg.setVisible(true)
  gg.processKill()
  os.exit()
  else
...
gg.addListItems(t)
t = nil
gg.alert("تم تفعيل حماية التجربة ")
end
...
os.remove("/storage/emulated/0/Android/data/com.tencent.ig/files/tbslog")
  ...
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(50000)
  gg.editAll("157567", gg.TYPE_DWORD)
  gg.clearResults()
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("135938", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(50000)
  gg.editAll("135938", gg.TYPE_DWORD)
  gg.clearResults()
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("135170", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(50000)
  gg.editAll("135170", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("135426", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(50000)
  gg.editAll("135426", gg.TYPE_DWORD)
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("135212", gg.TYPE_DWORD)
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(50000)
  gg.editAll("135212", gg.TYPE_DWORD)
  gg.clearResults()
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.setVisible(false)
  ...
  gg.refineNumber("0", gg.TYPE_DWORD)
  gg.getResults(50000)
  gg.editAll("133634", gg.TYPE_DWORD)
  gg.clearResults()
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("132098", gg.TYPE_DWORD)
...
os.remove("/storage/emulated/0/Android/data/com.tencent.ig/files/ProgramBinaryCache")
os.remove("/storage/emulated/0/Android/data/com.tencent.ig/files/tbslog")
gg.alert("⚠️ تم تفعيل الحماية بنجاح ⚠️ \n 🔥 الهدف الفوز في القيم وليس بعدد القتلى 🔥 \n ⛔ البطش الزائد يسبب البلاغات احذر ⛔")
end
...
function AqAq()
  SN4 = gg.choice({
    "《❄ [1] حماية جميع النسخ ( تفعيلين : ١. تدريب - ٢. لوبي ) - ترسيت  كل زون",
    "《🎯 [2] حماية اللوبي للنسخة العالميه فقط وتفعيلها في اللوبي",
    "《↩ رجوع للخلف ",
