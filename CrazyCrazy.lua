...
if gg.getResultCount() == 0 then
gg.alert("❌The 1st step failed, please try again!!❌ \n ❌ الخطوه الأولى خطأ قم بإغلاق اللعبه والمحاولة مجددا ❌")
else
...
if gg.getResultCount() == 0 then
gg.alert("❌The 2nd step failed, please try again!!❌ \n ❌ الخطوه الثانية خطأ قم بإغلاق اللعبه والمحاولة مجددا ❌")
else
local searchCount = gg.getResultCount()
local searchResults = gg.getResults(searchCount)
for i, v in ipairs(searchResults) do
