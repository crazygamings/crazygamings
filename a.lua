...
if XNotMenuX[4] == true then Damage() end 
if XNotMenuX[5] == true then NotXCrosshair() end 
...
function Damage()
WhoRapz.clearResults()
NotRange=gg.getRangesList('libUE4.so')[1].start  NotFind=0x3B64788  NotWrite(NotRange+NotFind,16,70)
WhoRapz.clearResults()
