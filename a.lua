...
if XNotMenuX[3] == true then NotXCrosshair() end 
if XNotMenuX[4] == true then NotXPointOfView() end 
if XNotMenuX[5] == true then NotXFoG() end 
if XNotMenuX[6] == true then NotXNightMode() end 
if XNotMenuX[7] == true then NotXGrass() end 
if XNotMenuX[8] == true then XNotExitX() end
end 
NotXRapz = -1
end
