...
function bantrly()
gg.alert('لا يوجد تجارب متاحة حاليا ... راجع المطور')
end
...
function NR100()
setvalue(gg.getRangesList("libUE4.so")[1].start + 0x1227C24, 16, 0)
setvalue(gg.getRangesList("libUE4.so")[1].start + 0x3426134, 4, 0)
setvalue(gg.getRangesList("libUE4.so")[1].start + 0x3426134, 4, 0)
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
...
function AqAq()
  SN4 = gg.choice({
    "《🟥️ [1] حماية جميع النسخ ( تفعيلين - ترسيت ) ",
    "《🟩 [2] حماية جميع النسخ ( ثلاثة تفعيلات - ترسيت ) ",
    "《🟪 [3] حماية جميع النسخ - تفعيل جيست أولا والعب ربع قيم ",
    "《↩ رجوع للخلف ",
...
MNA = gg.multiChoice({
"🔴 1- حماية اللوبي",
"🟤 2- حماية التدريب - أطلق ٢٠٠ طلقه بالتدريب وفعلها ",
"🔵 3- حماية اللوبي بعد الرجوع من التدريب",
"❌ رجوع إلى الخلف",
},nil, (os.date("")))
if MNA == nil then
else
...
gg.alert('🟩 تم تفعيل حماية لوبي رقم (1) . 🟩')
end
...
gg.refineNumber("144387", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
if gg.getResultCount() == 0 then
gg.alert('🟥 لم يجد القيمة الرجاء أعادة تشغيل اللعبة 🟥')
os.exit()
else
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
...
gg.alert('🟩 تم الانتهاء من الخطوه الأولى ... تابع 🟩')
TRAIN2()
end
end
...
gg.addListItems(NotXRapz)
gg.clearResults()
gg.alert('🟩 تم الانتهاء من الخطوه الثانية ... تابع 🟩')
end
