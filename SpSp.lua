...
gg.searchNumber("1.3520827e-52", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(100)
gg.editAll("0.1512985e-15", gg.TYPE_FLOAT)
gg.clearResults()
gg.clearResults()
gg.setRanges(gg.REGION_ANONYMOUS)
gg.searchNumber("23;30.5", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(5)
gg.editAll("400", gg.TYPE_QWORD | gg.TYPE_XOR | gg.TYPE_WORD | gg.TYPE_DWORD)
gg.clearResults()
gg.toast('🟩 Done 🟩')
end
